...
\t  ______                                     ______       _                   
\t / _____)                                   / _____)     (_)                  
\t( (____  _   _ ____  ____  _   _ ____  ____( (____  ____  _ ____  _____  ____ 
\t \\____ \\| | | |  _ \\|  _ \\| | | |    \\|  _ \\\\____ \\|  _ \\| |  _ \\| ___ |/ ___)
\t _____) ) |_| | | | | |_| | |_| | | | | |_| |____) ) | | | | |_| | ____| |    
\t(______/|____/|_| |_|  __/|____/|_|_|_|  __(______/|_| |_|_|  __/|_____)_|    
\t                    |_|               |_|                  |_|                
`;
...
function aff_main_menu() {
    console.log('\n');
    console.log(chalk_1.default.white('\t[1] - Snipe on pump'));
    console.log(chalk_1.default.white('\t[2] - Spam tx'));
    console.log(chalk_1.default.white('\t[3] - Settings'));
    console.log(chalk_1.default.white('\t[4] - Exit'));
    console.log("\n");
}
exports.aff_main_menu = aff_main_menu;
function aff_sniper_menu() {
    console.log(chalk_1.default.blueBright('\t[1] - Snipe on pump'));
